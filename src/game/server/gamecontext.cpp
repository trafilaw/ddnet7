...
void CGameContext::OnConsoleInit()
{
	...
	Console()->Register("pausegame", "?i[on/off]", CFGFLAG_SERVER|CFGFLAG_STORE, ConPause, this, "Pause/unpause game");
...
void CGameContext::LegacyCommandCallback(IConsole::IResult *pResult, void *pContext)
{
	...
	if (g_Config.m_SvSpamprotection && !str_startswith(pComContext->m_pCommand, "timeout ")
